...
import net.mloren.enchant_revised.block.entity.PedestalBlockEntity;
...
public class PedestalMenu extends AbstractContainerMenu
{
    ...
    public PedestalMenu(int containerId, Inventory inventory, FriendlyByteBuf extraData)
    {
        this(containerId, inventory, inventory.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public PedestalMenu(int containerId, Inventory inventory, BlockEntity blockEntity) {
