...
import net.mloren.enchant_revised.enchantment.custom.LightningStrikerEnchantmentEffect;

public class ModEnchantments
{
    public static final ResourceKey<Enchantment> LIGHTNING_STRIKER = ResourceKey.create(Registries.ENCHANTMENT,
        ResourceLocation.fromNamespaceAndPath(MainMod.MOD_ID, "lightning_striker"));
